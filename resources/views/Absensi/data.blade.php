        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    data-id="{{ $s->id }}" 
                    data-nama_karyawan="{{ $s->nama_karyawan }}"
                    data-tanggal_masuk="{{ $s->tanggal_masuk }}"
                    data-waktu_masuk="{{ $s->waktu_masuk }}"
                    data-status="{{ $s->status }}"
                    data-waktu_selesaikerja="{{ $s->waktu_selesaikerja }}"
                    >
