...
<section class="section dashboard">
    <div class="row">
        <div class="card-body">
            ...
            <button type="button" class="btn btn-warning btn-import" data-toggle="modal" data-target="#formImport">
                <i class = "fa fa-file-excel"></i> Import 
            </button>

            </a> <a href="{{route ('kategori-pdf')}}" class="btn btn-danger">
...
<script>
    ...
    $(function() {
        ...
        $('#modalEdit').on('show.bs.modal', function(e) 
        {
            ...
            $('.form-edit').attr('action',`{{ url("kategori") }}/${id}`)
        })
    })
</script>
@endpush